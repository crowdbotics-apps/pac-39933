"""
Django settings for pac_39933 project.
...
WSGI_APPLICATION = 'pac_39933.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "pac_39933 API",
    "DESCRIPTION": "API documentation for pac_39933 App",
    "VERSION": "v1",
}
